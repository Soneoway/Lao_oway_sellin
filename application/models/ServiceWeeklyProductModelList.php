<?php
class Application_Model_ServiceWeeklyProductModelList extends Zend_Db_Table_Abstract{
	protected $_name = 'service_weekly_product_model_list';

	function ServiceWeeklyProductModelListfetchPagination($page, $limit, &$total, $params){
