...
$get_resule = $QServiceStockShopList->getInventoryByBranch($total, $params,"0,1000"); 
...
$get_resule1 = $QServiceStockShopList->getInventoryByBranch($total, $params,$start01.",".$limit_item); 
$get_resule2 = $QServiceStockShopList->getInventoryByBranch($total, $params,$start02.",".$limit_item); 
$get_resule3 = $QServiceStockShopList->getInventoryByBranch($total, $params,$start03.",".$limit_item); 
