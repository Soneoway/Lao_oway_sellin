<?php
class Application_Model_ServiceGoodStockOut extends Zend_Db_Table_Abstract{
	protected $_name = 'service_good_stock_out';

	function ServiceProductStockOutListfetchPagination($page, $limit, &$total, $params){
