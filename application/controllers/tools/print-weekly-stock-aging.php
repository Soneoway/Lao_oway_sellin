...
$get_resule = $QServiceWeeklyStockShopList->getWeeklyStockAging($total, $params,"0,1000"); 
//echo $total;die;
...
$get_resule1 = $QServiceWeeklyStockShopList->getWeeklyStockAging($total, $params,$start01.",".$limit_item); 
$get_resule2 = $QServiceWeeklyStockShopList->getWeeklyStockAging($total, $params,$start02.",".$limit_item); 
$get_resule3 = $QServiceWeeklyStockShopList->getWeeklyStockAging($total, $params,$start03.",".$limit_item); 

//print_r($get_resule1);die;
