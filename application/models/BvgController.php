...
class BvgController extends My_Controller_Action
{
    ...
    function saveMassAction()
    {
        ...
        if ($this->getRequest()->getMethod() == 'POST') {
            ...
            define('MASS_BVG_LIST_COL_DEALER_NAME', 1);
            define('MASS_BVG_LIST_COL_IMEI', 2);
            define('MASS_BVG_LIST_COL_INVOICE_NUMBER', 3);
                ...
                try {
                    ...
                    for ($i = MASS_BVG_LIST_ROW_START; $i <= $highestRow; $i++) {
                        ...
                        $dealer_name = trim($objWorksheet
                            ->getCellByColumnAndRow(MASS_BVG_LIST_COL_DEALER_NAME, $i)
                            ->getValue());
                        ...
                        $invoice_date = trim($objWorksheet
                            ->getCellByColumnAndRow(MASS_BVG_LIST_COL_INVOICE_DATE, $i)
                            ->getValue());
