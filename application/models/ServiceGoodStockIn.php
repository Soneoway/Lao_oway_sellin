<?php
class Application_Model_ServiceGoodStockIn extends Zend_Db_Table_Abstract{
	protected $_name = 'service_good_stock_in';

	function ServiceProductStockInListfetchPagination($page, $limit, &$total, $params){
