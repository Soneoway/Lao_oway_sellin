...
$this->_helper->viewRenderer->setRender('cn-reward-service-view-print');
...
$OppoClub = new Application_Model_OppoClubRewardCn();
if ($creditnote_type == 'reward') {
	$oppo = $OppoClub->cn_reward_view_print($params, $imei);
