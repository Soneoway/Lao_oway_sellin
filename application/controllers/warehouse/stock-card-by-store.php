...
$to      		  = $this->getRequest()->getParam('out_time_from', date('Y-m-d'));
...
$this->view->url = HOST . 'warehouse/stock-card-by-store/' . ($params ? '?' .http_build_query($params) . '&' : '?');
...
$this->view->warehouse = $QWarehouse->fetchAll($where, 'name');
...
if ($this->getRequest()->isXmlHttpRequest())
{
    ...
    $this->_helper->viewRenderer->setRender('partials/stock_card_by_store_list');
}
