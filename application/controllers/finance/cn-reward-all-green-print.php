...
$this->_helper->viewRenderer->setRender('cn-reward-all-green-print');
...
$OppoAll = new Application_Model_oppoAllGreenRewardCn();
if ($creditnote_type == 'oppo_all_green') {
	$oppo = $OppoAll->cn_reward_view_print($params);
