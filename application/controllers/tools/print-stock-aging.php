...
$get_resule = $QServiceStockShopList->getStockAging($total, $params,"0,1000"); 
//echo $total;die;
...
$get_resule1 = $QServiceStockShopList->getStockAging($total, $params,$start01.",".$limit_item); 
$get_resule2 = $QServiceStockShopList->getStockAging($total, $params,$start02.",".$limit_item); 
$get_resule3 = $QServiceStockShopList->getStockAging($total, $params,$start03.",".$limit_item); 
