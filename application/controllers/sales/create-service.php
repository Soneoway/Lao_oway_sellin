...
//get acc product for swap acc
$QGood = new Application_Model_Good();
$where = $QGood->getAdapter()->quoteInto('cat_id = ? ', 12);
$goods_acc = $QGood->fetchAll($where, 'name');
$this->view->goods_acc = $goods_acc;


//get acc color for swap acc
$QGoodColor = new Application_Model_GoodColor();
$colors_acc = $QGoodColor->fetchAll(null,'name');
$this->view->colors_acc = $colors_acc;
