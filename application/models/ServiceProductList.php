<?php
class Application_Model_ServiceProductList extends Zend_Db_Table_Abstract{
	protected $_name = 'service_product_list';

	function ServiceProductListfetchPagination($page, $limit, &$total, $params){
