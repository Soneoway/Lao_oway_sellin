...
// 	}
		...
		if(isset($id)){
        $forceSale						= $QForceSale->get_cache($id);
        $forceSaleWarehouse 			= $QForceSaleWarehouse->get_cache($id);
        $forceSaleDistributor 			= $QForceSaleDistributor->get_cache($id);
        $forceSaleDetail				= $QForceSaleDetail->get_cache($id);
// echo "<pre>";
        // print_r($forceSaleWarehouse );die;
        $this->view->distributorSelect  = $forceSaleDistributor ;	
        $this->view->forceSaleSelect       = $forceSale;
        $this->view->warehousesSelect       = $forceSaleWarehouse;
        $this->view->forceSaleDetailSelect  = $forceSaleDetail;
