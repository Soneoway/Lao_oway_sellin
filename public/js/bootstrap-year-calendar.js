				...
				while(currentDate <= lastDate)
				{
					...
					do
					{
						...
						if(currentDate < firstDate) {
							...
							if((this.options.minDate != null && currentDate < this.options.minDate) || (this.options.maxDate != null && currentDate > this.options.maxDate) || currentDate.getDay() == 0 || currentDate.getDay() == 6)
							{
